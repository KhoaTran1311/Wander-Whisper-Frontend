...
const ImageViewer = ({fileInputRef}) => {
    ...
    return (
        <div className={`bg-zinc-500/30 w-96 sm:w-112 md:w-142 rounded-b-xl transition-[height,padding] border-zinc-700/30 ${imagePreviewUrls.length ? "h-32 p-4 shadow-xl border border-t-0 delay-150" : "h-0 p-0 delay-0"}`}>
